...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<T> items,  bool isLoading,  bool isLoadingMore,  bool hasStartedLoadingMore,  int currentPage,  int totalPages,  int totalItems,  int itemsPerPage,  bool hasReachedMax,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginatedData() when $default != null:
return $default(_that.items,_that.isLoading,_that.isLoadingMore,_that.hasStartedLoadingMore,_that.currentPage,_that.totalPages,_that.totalItems,_that.itemsPerPage,_that.hasReachedMax,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<T> items,  bool isLoading,  bool isLoadingMore,  bool hasStartedLoadingMore,  int currentPage,  int totalPages,  int totalItems,  int itemsPerPage,  bool hasReachedMax,  String? error)  $default,) {final _that = this;
switch (_that) {
case _PaginatedData():
return $default(_that.items,_that.isLoading,_that.isLoadingMore,_that.hasStartedLoadingMore,_that.currentPage,_that.totalPages,_that.totalItems,_that.itemsPerPage,_that.hasReachedMax,_that.error);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<T> items,  bool isLoading,  bool isLoadingMore,  bool hasStartedLoadingMore,  int currentPage,  int totalPages,  int totalItems,  int itemsPerPage,  bool hasReachedMax,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _PaginatedData() when $default != null:
return $default(_that.items,_that.isLoading,_that.isLoadingMore,_that.hasStartedLoadingMore,_that.currentPage,_that.totalPages,_that.totalItems,_that.itemsPerPage,_that.hasReachedMax,_that.error);case _:
  return null;
