...
import 'package:shoppi/features/products/presentation/pages/search_products.dart'
    as _i11;
import 'package:shoppi/features/products/products.dart' as _i16;

/// generated route for
/// [_i1.AllProductsByCategoryScreen]
class AllProductsByCategoryRoute
    extends _i14.PageRouteInfo<AllProductsByCategoryRouteArgs> {
  AllProductsByCategoryRoute({
    _i15.Key? key,
    required _i16.Categorymodel categorymodel,
...
class AllProductsByCategoryRouteArgs {
  ...
  final _i16.Categorymodel categorymodel;
...
class ChooseLanguageRoute extends _i14.PageRouteInfo<void> {
  const ChooseLanguageRoute({List<_i14.PageRouteInfo>? children})
...
class LoginRoute extends _i14.PageRouteInfo<LoginRouteArgs> {
  ...
  static _i14.PageInfo page = _i14.PageInfo(
    ...
    builder: (data) {
      ...
      return _i6.LoginPage(key: args.key, onResults: args.onResults);
    },
  );
}
...
class OrdersRoute extends _i14.PageRouteInfo<void> {
  const OrdersRoute({List<_i14.PageRouteInfo>? children})
...
class ProductDetailRoute extends _i14.PageRouteInfo<ProductDetailRouteArgs> {
  ...
  static _i14.PageInfo page = _i14.PageInfo(
    ...
    builder: (data) {
      ...
      return _i9.ProductDetailPage(key: args.key, id: args.id);
    },
  );
}
...
/// generated route for
/// [_i11.SearchProductsScreen]
class SearchProductsRoute extends _i14.PageRouteInfo<void> {
  const SearchProductsRoute({List<_i14.PageRouteInfo>? children})
  ...
  static _i14.PageInfo page = _i14.PageInfo(
    name,
    builder: (data) {
      return const _i11.SearchProductsScreen();
    },
  );
}
