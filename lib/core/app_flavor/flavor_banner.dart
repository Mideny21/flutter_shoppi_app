...
//   const FlavorBanner({Key? key, required this.child, this.bannerConfig})
//     : super(key: key);
...
//       children: <Widget>[
//         child,
//         _buildBanner(context: context, bannerConfig: config),
//       ],
//     );
//   }
...
//   _TriangleClipper({required this.location});
